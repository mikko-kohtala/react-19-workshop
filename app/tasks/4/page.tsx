	...
	return (
		<>
			<div className="space-y-4">
				...
				<p className="text-lg">
					Explore React 19's new use() hook for simplified Context consumption
					and cleaner component architecture.
				</p>
			</div>
			...
			<div className="space-y-6">
				<div className="space-y-4">
					...
					<p>
						Learn how React 19's new use() hook makes working with Context more
						intuitive and less verbose than useContext, providing better
						TypeScript integration and cleaner component code.
					</p>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="space-y-4">
						<ol className="list-decimal pl-6 space-y-4">
							<li>
								<p>
									Work in the file <code>app/tasks/4/work/page.tsx</code> -
									character data fetching and basic structure are already
									implemented for you.
								</p>
							</li>
							<li>
								<p>
									Create a character selection interface with a theme/settings
									Context using React 19's new use() hook instead of the
									traditional useContext.
								</p>
							</li>
							<li>
								<p>
									Implement a comprehensive theme system with light, dark, and
									cosmic modes that affects the visual styling of all
									components.
								</p>
							</li>
							<li>
								<p>
									Create nested components that consume the context using the
									simplified use() API.
								</p>
							</li>
							<li>
								<p>
									Test the theme switching and display mode changes to see how
									the use() hook simplifies Context consumption across multiple
									components.
								</p>
							</li>
						</ol>
					...
					<div className="space-y-4">
						...
						<div className="rounded-lg border p-4 bg-neutral-50">
							<ul className="list-disc pl-6 space-y-2 text-sm">
								<li>
									<strong>use() Hook:</strong> Replace useContext(MyContext)
									with use(MyContext).
								</li>
								<li>
									<strong>Context Structure:</strong> Create theme/settings
									context with clear state management.
								</li>
								<li>
									<strong>Component Hierarchy:</strong> Show how use()
									simplifies nested component consumption.
								</li>
								<li>
									<strong>State Updates:</strong> Demonstrate context updates
									affecting all consuming components.
								</li>
								<li>
									<strong>Theme System:</strong> Implement multiple visual
									themes with consistent styling.
								</li>
								<li>
									<strong>Error Boundaries:</strong> Handle context not
									available scenarios gracefully.
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
						<div className="rounded-lg border p-4">
							...
							<p className="text-sm text-neutral-600 mb-3">
								Implement React 19 improvements
							</p>
							<Link
								href="/tasks/4/work"
				...
				<div className="rounded-lg border p-6 bg-green-50">
					...
					<ul className="list-disc pl-5 text-sm text-green-700 space-y-1">
						...
						<li>
							Implementing Context providers with React 19's simplified patterns
						</li>
						<li>Building responsive theme systems with context state</li>
						<li>
							Creating cleaner component hierarchies with modern React patterns
						</li>
						<li>Managing application-wide settings with the new Context API</li>
						<li>
							Understanding the benefits of the use() hook over traditional
							patterns
						</li>
					</ul>
				</div>
