		...
		<>
			<div className="space-y-4">
				<h1 className="text-4xl font-bold">
					Solution: Client Components with Rick and Morty
				</h1>
				<p className="text-lg">
					Complete implementation showing Server/Client Component integration.
				</p>
			</div>
			...
			<div className="space-y-6">
				<div className="rounded-lg border p-6 bg-green-50">
					...
					<p className="text-sm text-green-700 mb-2">
						This solution demonstrates the optimal Server/Client Component
						architecture:
					</p>
					<ul className="list-disc pl-5 text-sm text-green-700 space-y-1">
						<li>Data fetching happens on the server in the Server Component</li>
						<li>
							FavoriteButton is a separate Client Component with 'use client'
							directive
						</li>
				...
				<div className="rounded-lg border p-6 bg-purple-50">
					...
					<div className="space-y-2 text-sm font-mono">
						<div>
							📄 <code>app/tasks/2/solution/page.tsx</code> - Server Component
							(this file)
						</div>
						<div>
							📄 <code>app/tasks/2/solution/favorite-button.tsx</code> - Client
							Component
						</div>
					</div>
					<p className="text-sm text-purple-700 mt-2">
						This separation allows for optimal performance: server-rendered
						content with client-side interactivity only where needed.
					</p>
				</div>
