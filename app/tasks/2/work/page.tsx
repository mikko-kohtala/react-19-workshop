	...
	return (
		<>
			<div className="space-y-4">
				...
				<p className="text-lg">
					Add client-side interactivity to the server-rendered character data.
				</p>
			</div>
			...
			<div className="space-y-6">
				<div className="rounded-lg border p-4 bg-blue-50">
					<h2 className="text-lg font-semibold mb-2">
						✅ Server-Side Fetching Complete
					</h2>
					<p className="text-sm text-blue-700">
						The Rick and Morty character data is already being fetched on the
						server. Your task is to add a FavoriteButton Client Component to
						each character card.
					</p>
				</div>
				...
				<div className="rounded-lg border p-4 bg-yellow-50">
					...
					<p className="text-sm text-yellow-700 mb-2">
						Create a FavoriteButton component and add it to each character card
						below:
					</p>
