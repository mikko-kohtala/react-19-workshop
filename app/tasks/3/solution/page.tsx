...
const characterRatings: Record<
	...
	{
		ratings: number[];
		comments: { rating: number; comment: string; timestamp: string }[];
	}
> = {};
...
function RatingDisplay({ characterId }: RatingDisplayProps) {
	const { averageRating, totalRatings, comments } =
		getCharacterRatings(characterId);
		...
		<>
			<div className="space-y-4">
				<h1 className="text-4xl font-bold">
					Solution: Server Actions with Character Ratings
				</h1>
				<p className="text-lg">
					Complete implementation of Server Actions for form submission without
					API routes.
				</p>
			</div>
			...
			<div className="space-y-6">
				<div className="rounded-lg border p-6 bg-green-50">
					...
					<p className="text-sm text-green-700 mb-2">
						This solution demonstrates Server Actions for handling form
						submissions:
					</p>
					<ul className="list-disc pl-5 text-sm text-green-700 space-y-1">
						<li>
							Server Action with 'use server' directive for rating submission
						</li>
						<li>
							Form components that work as Server Components (no client-side
							JavaScript)
						</li>
						<li>
						...
						<li>
							Automatic revalidation after form submission via revalidatePath()
						</li>
						<li>
							In-memory storage for ratings (would be database in real app)
						</li>
					</ul>
				</div>
				...
				{characters.length === 0 ? (
					...
					<div className="space-y-4">
						<h2 className="text-2xl font-bold">
							Rick and Morty Characters ({characters.length} showing)
						</h2>
				...
				<div className="rounded-lg border p-6 bg-purple-50">
					...
					<ul className="list-disc pl-5 text-sm text-purple-700 space-y-1">
						...
						<li>
							Notice how the page updates automatically to show your rating
							immediately
						</li>
