	...
	return (
		<>
			<div className="space-y-4">
				...
				<p className="text-lg">
					Add a character rating system using Server Actions.
				</p>
			</div>
			...
			<div className="space-y-6">
				<div className="rounded-lg border p-4 bg-blue-50">
					<h2 className="text-lg font-semibold mb-2">
						✅ Character Data Fetching Complete
					</h2>
					<p className="text-sm text-blue-700">
						The Rick and Morty character data is already being fetched on the
						server. Your task is to add a Server Action for rating characters.
					</p>
				</div>
				...
				<div className="rounded-lg border p-4 bg-yellow-50">
					...
					<p className="text-sm text-yellow-700 mb-2">
						Create a Server Action and form to rate characters:
					</p>
				...
				<div className="rounded-lg border p-4 bg-green-50">
					...
					<ul className="list-disc pl-5 text-sm text-green-700 space-y-1">
						<li>
							<strong>No API routes needed:</strong> Server Actions eliminate
							the need for separate API endpoints
						</li>
						<li>
						...
						<li>
							<strong>Automatic revalidation:</strong> Server Components
							re-render automatically after actions
						</li>
						<li>
							<strong>Type safety:</strong> Full TypeScript support between
							client forms and server actions
						</li>
						<li>
							<strong>Simplified data flow:</strong> Direct form submission to
							server-side logic
						</li>
					</ul>
				</div>
