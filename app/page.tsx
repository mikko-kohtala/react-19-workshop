			...
			<SidebarInset>
				...
				<div className="flex flex-1 flex-col gap-8 p-8">
					<div className="space-y-4">
						...
						<p className="text-lg">
							Learn about the latest features in React 19 through this
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						>
							<div className="space-y-2">
								...
								<p>
									Learn about React 19's new features, including Server
									Components, Actions, and the React Compiler.
								</p>
							</div>
						</Link>
						...
						>
							<div className="space-y-2">
								...
								<p>
									Get hands-on experience with React 19's features through
					...
					<div className="rounded-lg border p-6 bg-green-50">
						...
						<div className="space-y-4">
							<p>
								Ready to dive in? You can either use the hosted version or run
								the workshop locally on your machine.
							</p>
							...
							<div className="grid gap-4 md:grid-cols-2">
								<div className="bg-white rounded p-4 border">
									...
									<p className="text-sm mb-3">
										Access the workshop immediately without any setup:
									</p>
									<a
								...
								<div className="bg-white rounded p-4 border">
									...
									<p className="text-sm mb-3">
										Clone and run on your machine for full development
										experience.
									</p>
									<a
								...
								<div className="space-y-3">
									<div>
										...
										<ul className="list-disc pl-6 space-y-1 text-sm">
											...
											<li>
												Experience with React, TypeScript. Next.js experience
												helps.
											</li>
											<li>
					...
					<div className="rounded-lg border p-6">
						...
						<div className="space-y-4">
							<p>
								This workshop is designed to help you understand and implement
								React 19's new features. The presentation provides an overview
								of the key concepts, while the tasks give you hands-on
								experience with implementing these features.
							</p>
							...
							<ul className="list-disc pl-6 space-y-2">
								...
								<li>
									Server Actions for handling form submissions and data
									mutations
								</li>
								<li>Client Components and when to use them</li>
								<li>
									React 19's enhanced metadata handling and simplified Context
									API
								</li>
					...
					<div className="rounded-lg border p-6 bg-blue-50">
						...
						<div className="space-y-4">
							<p>
								This workshop is built with <strong>Next.js 15</strong> using
								the App Router, which provides a powerful folder-based routing
								system. Each folder in the <code>app/</code> directory
								represents a URL segment, making navigation intuitive and
								organized.
							</p>
							...
							<p className="text-sm text-neutral-600">
								This structure enables React 19's Server Components to work
								seamlessly with Next.js, allowing server-side rendering and
					...
					<div className="rounded-lg border p-6 bg-gradient-to-br from-purple-50 to-blue-50">
						...
						<div className="space-y-4">
							...
							<p className="text-gray-700">
								Enjoys sharing knowledge and helping developers stay up-to-date
							...
							<div className="bg-white/70 rounded-lg p-4 border border-purple-100">
								<h3 className="font-semibold text-purple-900 mb-2">
									🚀 About Knowit Javascript Guild
								</h3>
								<p className="text-sm text-gray-700 mb-3">
									This workshop was created as part of the Knowit Javascript
									Guild - a community of passionate JavaScript developers
									sharing knowledge, best practices, and exploring the latest
							...
							<div className="text-xs text-gray-600 pt-2 border-t border-purple-100">
								<p>
									💡 <strong>Tip:</strong> Found this workshop helpful? Star the
									repository and share it with your team!
								</p>
							</div>
						</div>
					</div>
