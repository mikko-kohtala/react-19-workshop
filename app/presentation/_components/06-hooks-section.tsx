	...
	return (
		<section id="hooks" className="space-y-4">
			<h2 className="text-3xl font-bold">
				06. New Hooks for Actions and Transitions
			</h2>
			<div className="space-y-4">
				<p>
					React 19 introduces three new hooks to complement Actions and improve
					UX for interactions:
				</p>
				<div className="space-y-4">
					<div>
						...
						<p>
							New in React 19, this hook simplifies managing form state and
							submission outcomes. It takes an action function and an initial
							state, returning the current state, a wrapped action to pass to
							the form, and a pending status.
						</p>
					...
					<div>
						...
						<p>
							New in React 19, this hook provides the status (pending, data,
							method, action) of the parent <code>&lt;form&gt;</code>{" "}
							submission. It must be used within a component that is a
							descendant of a <code>&lt;form&gt;</code>. Useful for showing
							loading states on submit buttons or displaying submitted data.
						</p>
						<div className="my-4">
							<CodeBlock
					...
					<div>
						...
						<p>
							New in React 19, this hook enables optimistic UI updates. It
							allows you to update the UI immediately as if an async action
							(like a Server Action) has succeeded, then reconciles with the
							actual result when it returns.
						</p>
