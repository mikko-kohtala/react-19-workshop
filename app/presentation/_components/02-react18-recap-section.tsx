	...
	return (
		<section id="react18" className="space-y-4">
			...
			<div className="space-y-4">
				<p>
					React 18 introduced several groundbreaking features that set the stage
					for React 19:
				</p>
				...
				<p>
					React 18 also introduced experimental Server Components, but they
					weren&apos;t widely adopted. This sets the stage for why React
					19&apos;s updates are so important - they make these features stable
